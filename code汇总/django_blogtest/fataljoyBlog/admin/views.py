...
from fataljoyBlog.blogapp.models import fj_user
from django.views.decorators.csrf import csrf_exempt
from django.contrib.auth import authenticate,login,logout
from fataljoyBlog.blogapp.views import home
import logging
import simplejson
...
def check_auth_redirect(request,template_name):
    ...
    if request.user.is_authenticated():
       ...
       #return render_to_response("fataljoyadmin/index.html")
...
def console(request):
    return render_to_response("fataljoyadmin/index.html",{"currentUser":request.user})

def fataljoylogout(request):
    logout(request)
