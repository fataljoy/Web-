"""
Django settings for fataljoyBlog project.
...
ROOT_URLCONF = 'fataljoyBlog.urls'

WSGI_APPLICATION = 'fataljoyBlog.wsgi.application'
...
TEMPLATE_DIRS=(
    #"F:/PythonDjangoWeb/fataljoyBlog/fataljoyBlog/template",
